...
namespace ParticleThumbnailAndPreview.Editor
{
    ...
    internal static class PreviewGridSystem
    {
        ...
        private const bool AxisArrowsEnabled = true;
        private const float AxisMarkerDistanceSteps = 2;
        ...
        private static Mesh BuildAxisMarkerMesh(float step, float alpha, bool drawText)
        {
            ...
            AddAxisMarker(vertices, colors, triangles, Vector3.right, distance, lift, shaftLength, headLength, halfWidth, textHeight, stroke, textOffset, characterSpacing, "+X", new Color(1f, 0.35f, 0.35f, markerAlpha), AxisArrowsEnabled, drawText);
            AddAxisMarker(vertices, colors, triangles, Vector3.left, distance, lift, shaftLength, headLength, halfWidth, textHeight, stroke, textOffset, characterSpacing, "-X", new Color(1f, 0.56f, 0.56f, markerAlpha), AxisArrowsEnabled, drawText);
            AddAxisMarker(vertices, colors, triangles, Vector3.forward, distance, lift, shaftLength, headLength, halfWidth, textHeight, stroke, textOffset, characterSpacing, "+Z", new Color(0.34f, 0.74f, 1f, markerAlpha), AxisArrowsEnabled, drawText);
            AddAxisMarker(vertices, colors, triangles, Vector3.back, distance, lift, shaftLength, headLength, halfWidth, textHeight, stroke, textOffset, characterSpacing, "-Z", new Color(0.54f, 0.82f, 1f, markerAlpha), AxisArrowsEnabled, drawText);
